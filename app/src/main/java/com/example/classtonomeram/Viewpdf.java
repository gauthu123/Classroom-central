...
public class Viewpdf extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  storage = FirebaseStorage.getInstance("gs://classtonomer-am.appspot.com/Iq9WB6Nyf2X4tYq2ix2Hvff0xOT");
        storage = FirebaseStorage.getInstance("gs://classtonomer-am.appspot.com");
